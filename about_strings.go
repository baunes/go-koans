...
func aboutStrings() {
	...
	assert("smith" < "smithsonian") // i suppose maybe this could be useful.. someday
	...
	assert(fmt.Sprintf("hello %s", "hello world") == "hello hello world") // our old friend sprintf returns
